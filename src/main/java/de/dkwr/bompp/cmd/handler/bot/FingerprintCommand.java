 ...
 */
public class FingerprintCommand extends AbstractBotCommand {

    private final OmemoController omemoController;

    public FingerprintCommand(OmemoController omemoController) {
        super("/fingerprint", Optional.empty(), "Prints the bots fingerprint");
